        ...
        <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
            <div className="px-2 flex justify-between items-center w-full h-full">
                <div className='flex items-center'>
                    <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>DREAM.</h1>
                ...
                <div className="md:hidden" onClick={handleClick}>
                    {!nav ? <Bars4Icon className='w-5' /> : <XCircleIcon className='w-5'></XCircleIcon>}
                </div>
            </div>
            <ul className={!nav ? 'hidden mr-4' : 'absolute bg-zinc-200 px-8 w-full'}>

            <li className=' border-b-2 border-zinc-300 w-full'><Link onClick = {handleClose} to="home" smooth={true}duration={500}>
                            Home
                        </Link>
                        </li>
                ...
                <div className=' flex flex-col my-4'>
                    <button className=' bg-transparent px-8 py-3 text-indigo-600 mb-4'>Sign In</button>
                    <button className='px-8 py-3'>Sign Up</button>
                </div>
            </ul>
        </div>
